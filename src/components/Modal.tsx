...
const Modal = ({ isOpen, children }: GenericModalProps) => {
    return (
        <>
            {isOpen && <div id="default-modal" tabIndex={-1} aria-hidden="true" className="bg-black/20 overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0  max-h-full">
